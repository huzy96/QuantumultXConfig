...
> 特别提醒：如需转载请注明出处，谢谢合作！
> 原始地址：https://raw.githubusercontent.com/ddgksf2013/Scripts/master/amap.js
***********************************************/
...
if (-1 != $request.url.indexOf("valueadded/alimama/splash_screen")) {
    ...
    obj.data?.cardList && (obj.data.cardList = Object.values(obj.data.cardList).filter(a => "LoginCard" == a.dataType || "FrequentLocation" == a.dataType));
    ...
    obj.data?.cardList && (obj.data.cardList = Object.values(obj.data.cardList).filter(a => "MyOrderCard" == a.dataType || "GdRecommendCard" == a.dataType));
    $done({
        body: JSON.stringify(obj)
    });
}
