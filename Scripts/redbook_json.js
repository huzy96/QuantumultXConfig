    ...
    switch (!0) {
        case /api\/sns\/v\d\/note\/widgets/.test($request.url):
            try {
                let e = JSON.parse(body),
                    t = ["1goods_card_v2", "note_next_step"];
        ...
        case /api\/sns\/v\d\/note\/redtube/.test($request.url):
            try {
                ...
                }), d.share_info && (d.share_info.function_entries = [{
                    type: "video_download"
                }, {
                    type: "generate_image"
                }, {
        ...
        case /api\/sns\/v\d\/note\/videofeed/.test($request.url):
            try {
                ...
                for (let l of i.data) l.related_goods_num && (l.related_goods_num = 0), l.has_related_goods && (l.has_related_goods = !1), l.media_save_config && (l.media_save_config = {
                    ...
                    disable_watermark: !0,
                    disable_weibo_cover: !0
                }), l.share_info && (l.share_info.function_entries = [{
                    type: "video_download"
                }, {
                    type: "generate_image"
                }, {
            ...
            try {
                ...
                for (let y of c.data)
                    if (y.related_goods_num && (y.related_goods_num = 0), y.has_related_goods && (y.has_related_goods = !1), y.note_list)
                        for (let g of y.note_list) g.media_save_config = {
                            disable_save: !1,
                            disable_watermark: !0,
                            disable_weibo_cover: !0
                        };
        ...
        case /api\/sns\/v\d\/note\/imagefeed/.test($request.url):
            try {
                ...
                for (let p of b.data)
                    if (p.related_goods_num && (p.related_goods_num = 0), p.has_related_goods && (p.has_related_goods = !1), p.note_list)
                        for (let h of p.note_list) h.media_save_config = {
                            disable_save: !1,
                            disable_watermark: !0,
                            disable_weibo_cover: !0
                        };
