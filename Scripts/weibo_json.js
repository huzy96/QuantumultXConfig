...
> 脚本地址：https://raw.githubusercontent.com/ddgksf2013/Scripts/master/weibo_json.js
...
function isAd(a) {
  return (
    !!a &&
    (!(
      "公告" != a.mblogtypename && "热推" != a.mblogtypename
    ) || !("ad" != a.promotion?.type) || !("ad" != a.page_info?.actionlog?.source) || !("公告" != a.content_auth_info?.content_auth_title))
  );
}
